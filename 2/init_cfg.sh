...
curl -fsSLo /etc/apt/keyrings/kubernetes-archive-keyring.gpg https://dl.k8s.io/apt/doc/apt-key.gpg >/dev/null 2>&1
curl -s https://dl.k8s.io/apt/doc/apt-key.gpg | apt-key add -
