...
kubectl apply -f kubectl apply -f https://raw.githubusercontent.com/flannel-io/flannel/master/Documentation/kube-flannel.yml >/dev/null 2>&1
...
kubectl apply -f https://raw.githubusercontent.com/Beas-github/test/master/2/metrics-server.yaml >/dev/null 2>&1
