...
apt-get install prettyping sshpass bridge-utils net-tools jq tree resolvconf wireguard ngrep tcpdump ipset iputils-arping ipvsadm vim unzip conntrack -y -qq >/dev/null 2>&1
