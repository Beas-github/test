...
echo "[TASK 1] K8S Controlplane Join - API Server 192.168.56.200" 
kubeadm join --token 123456.1234567890123456 --discovery-token-unsafe-skip-ca-verification 192.168.56.200:6443 >/dev/null 2>&1
